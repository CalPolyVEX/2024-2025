...
int main() {
   ...
   for(int counter=0;counter<1;counter++)
   {
      ...
      //convert the top 4 to floats
      //get the top 4 s16: vget_low_s16(u0)
      //int32x4_t vmovl_s16 (int16x4_t)
      
      //convert 4 low (4 low out of 8) Red values
      float32x4_t y0_temp_low = vcvtq_f32_s32(vmovl_s16(vget_low_s16(y0_a))); //convert to 4 floats
      y0_temp_low *= vdupq_n_f32(1.164); 
   ...
   printf ("%d\n", vget_lane_s16 (vget_low_s16(u0), 0));
   printf ("%d\n", vget_lane_s16 (vget_low_s16(v0), 0));
   printf ("%d\n", vget_lane_s16 (vget_low_s16(y0_b), 0));
   printf ("%d\n", vget_lane_s16 (vget_low_s16(u2), 0));
   printf ("%f\n", vget_lane_f32 (vget_low_f32(y_const), 0));
