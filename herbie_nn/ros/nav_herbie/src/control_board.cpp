//This file contains code to send messages to the control board
...
void Navigation::create_control_board_msg(int num, void* arg) {
   ...
   if (num == 7 || num == 8) { //led on/off
      ...
      control_board_pub_.publish(test_msg); //publish the message
      return;
   }
...
unsigned short Navigation::compute_crc(unsigned char* data, int len) {
