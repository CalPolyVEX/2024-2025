...
bool button_expanded::just_released() { return this->has_changed() && this->is_pressed(); }

bool button_expanded::has_changed() { return this->value != this->prev_value; }

bool button_expanded::is_toggled() { return this->toggled; }
