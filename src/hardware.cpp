...
// ----------------------------- motors -----------------------------
pros::Motor fish_mech(3, pros::MotorCartridge::red); // TODO rename this
pros::Motor conveyor(-2, pros::MotorGearset::blue);
pros::Motor intake(-6, pros::MotorCartridge::blumechanismse);
...
pros::Motor intake(-5, pros::MotorCartridge::blue);
