...
void decodeData() {
  ...
  channel[0] = (dataBuffer[1] | dataBuffer[2] << 8 ) & 0x7FF;
  channel[1] = (dataBuffer[2] >> 3 | dataBuffer[3] << 5) & 0x7FF;
  channel[2] = (dataBuffer[3] >> 6 | dataBuffer[4] << 2 | dataBuffer[5] << 10) & 0x7FF;
  channel[3] = (dataBuffer[5] >> 1 | dataBuffer[6] << 7) & 0x7FF;
  channel[4] = (dataBuffer[6] >> 4 | dataBuffer[7] << 4) & 0x7FF;
  channel[5] = (dataBuffer[7] >> 7 | dataBuffer[8] << 1 | dataBuffer[9] << 9) & 0x7FF;
  channel[6] = (dataBuffer[9] >> 2 | dataBuffer[10] << 6) & 0x7FF;
  channel[7] = (dataBuffer[10] >> 5 | dataBuffer[11] << 3) & 0x7FF;
  channel[8] = (dataBuffer[12] | dataBuffer[13] << 8) & 0x7FF;
  channel[9] = (dataBuffer[13] >> 3 | dataBuffer[14] << 5) & 0x7FF;
  channel[10] = (dataBuffer[14] >> 6 | dataBuffer[15] << 2 | dataBuffer[16] << 10) & 0x7FF;
  channel[11] = (dataBuffer[16] >> 1 | dataBuffer[17] << 7) & 0x7FF;
  channel[12] = (dataBuffer[17] >> 4 | dataBuffer[18] << 4) & 0x7FF;
  channel[13] = (dataBuffer[18] >> 7 | dataBuffer[19] << 1 | dataBuffer[20] << 9) & 0x7FF;
  channel[14] = (dataBuffer[20] >> 2 | dataBuffer[21] << 6) & 0x7FF;
  channel[15] = (dataBuffer[21] >> 5 | dataBuffer[22] << 3) & 0x7FF;
}
