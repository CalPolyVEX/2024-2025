// Code that takes inputs and checks validitiy
...
// Reads and returns the command of an input
...
// Reads and returns the size of package
...
void eval_input(char* data, int size)
{
	...
	// Set LCD
	case 3:
		lcd.set_cursor(data[3] && 0x03, (data[3] && 0xFC) >> 2);
		break;
	// Print String
	case 4:
		int string_size = size - 6;
		char* string = new char[string_size];
		for (int i = 0, j = 4; i < string_size; i++, j++)
			string[i] = data[j];
		lcd.print(string_size, string)
		delete string;
		break;
	};
}

// Retrieves input from USB and executes request
void get_input()
{
