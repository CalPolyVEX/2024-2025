 ...
 */
static inline void lv_slider_set_range(lv_obj_t* obj, int32_t min, int32_t max) { lv_bar_set_range(obj, min, max); }
 ...
 */
static inline int32_t lv_slider_get_value(const lv_obj_t* obj) { return lv_bar_get_value(obj); }
 ...
 */
static inline int32_t lv_slider_get_left_value(const lv_obj_t* obj) { return lv_bar_get_start_value(obj); }
 ...
 */
static inline int32_t lv_slider_get_min_value(const lv_obj_t* obj) { return lv_bar_get_min_value(obj); }
 ...
 */
static inline int32_t lv_slider_get_max_value(const lv_obj_t* obj) { return lv_bar_get_max_value(obj); }
