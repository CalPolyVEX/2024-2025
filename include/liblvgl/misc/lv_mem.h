 ...
 */
static inline void* lv_memcpy(void* dst, const void* src, size_t len) { return memcpy(dst, src, len); }
 ...
 * @param len number of byte to copy
 */
static inline void* lv_memcpy_small(void* dst, const void* src, size_t len) { return memcpy(dst, src, len); }
 ...
 */
static inline void lv_memset(void* dst, uint8_t v, size_t len) { memset(dst, v, len); }
 ...
 * @param len number of byte to set
 */
static inline void lv_memset_00(void* dst, size_t len) { memset(dst, 0x00, len); }
 ...
 * @param len number of byte to set
 */
static inline void lv_memset_ff(void* dst, size_t len) { memset(dst, 0xFF, len); }
