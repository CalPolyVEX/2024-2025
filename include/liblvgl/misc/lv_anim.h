 ...
 *                  E.g. lv_obj_set_x
 */
static inline void lv_anim_set_exec_cb(lv_anim_t* a, lv_anim_exec_xcb_t exec_cb) { a->exec_cb = exec_cb; }
 ...
 */
static inline void lv_anim_set_time(lv_anim_t* a, uint32_t duration) { a->time = duration; }
 ...
 */
static inline void lv_anim_set_delay(lv_anim_t* a, uint32_t delay) { a->act_time = -(int32_t)(delay); }
 ...
 */
static inline void lv_anim_set_path_cb(lv_anim_t* a, lv_anim_path_cb_t path_cb) { a->path_cb = path_cb; }
 ...
 */
static inline void lv_anim_set_start_cb(lv_anim_t* a, lv_anim_start_cb_t start_cb) { a->start_cb = start_cb; }
 ...
 */
static inline void lv_anim_set_ready_cb(lv_anim_t* a, lv_anim_ready_cb_t ready_cb) { a->ready_cb = ready_cb; }
 ...
 */
static inline void lv_anim_set_deleted_cb(lv_anim_t* a, lv_anim_deleted_cb_t deleted_cb) { a->deleted_cb = deleted_cb; }
 ...
 */
static inline void lv_anim_set_playback_time(lv_anim_t* a, uint32_t time) { a->playback_time = time; }
 ...
 */
static inline void lv_anim_set_playback_delay(lv_anim_t* a, uint32_t delay) { a->playback_delay = delay; }
 ...
 */
static inline void lv_anim_set_repeat_count(lv_anim_t* a, uint16_t cnt) { a->repeat_cnt = cnt; }
 ...
 */
static inline void lv_anim_set_repeat_delay(lv_anim_t* a, uint32_t delay) { a->repeat_delay = delay; }
 ...
 */
static inline void lv_anim_set_early_apply(lv_anim_t* a, bool en) { a->early_apply = en; }
 ...
 */
#if LV_USE_USER_DATA
static inline void lv_anim_set_user_data(lv_anim_t* a, void* user_data) { a->user_data = user_data; }
#endif
