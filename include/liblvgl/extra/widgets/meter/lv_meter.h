 ...
 */
void lv_meter_set_scale_major_ticks(lv_obj_t* obj, lv_meter_scale_t* scale, uint16_t nth, uint16_t width, uint16_t len,
 ...
 */
lv_meter_indicator_t* lv_meter_add_needle_line(lv_obj_t* obj, lv_meter_scale_t* scale, uint16_t width, lv_color_t color,
                                               int16_t r_mod);
 ...
 * @param local         tell how to map start and end color. true: the indicator's start and end_value; false: the
 * scale's min max value
