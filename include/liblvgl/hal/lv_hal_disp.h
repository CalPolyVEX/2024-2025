...
typedef struct _lv_disp_draw_buf_t {
    ...
    /*1: flushing is in progress. (It can't be a bit field because when it's cleared from IRQ Read-Modify-Write
     * issue might occur)*/
...
typedef struct _lv_disp_drv_t {
    ...
    lv_coord_t physical_hor_res; /**< Horizontal resolution of the full / physical display. Set to -1 for fullscreen
                                    mode.*/
    lv_coord_t
