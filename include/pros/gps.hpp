...
class Gps : public Device {
    ...
    public:
         ...
         * \param headingInitial
         * 				 Initial Heading, with 0 being North, 90 being East, 180 being South, and 270 being West
         * (degrees) \param xOffset Cartesian 4-Quadrant X offset from center of turning (meters) \param yOffset
         * 				 Cartesian 4-Quadrant Y offset from center of turning (meters)
         *
         * \b Example:
         * \code
