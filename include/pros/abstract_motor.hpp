...
class AbstractMotor {
    ...
    public:
         ...
         *
         *
         * \return A vector containing the motor's/motors' efficiency/efficiencies in percent or PROS_ERR_F if the
         * operation failed, setting errno.
         */
        ...
        virtual std::int32_t set_encoder_units(const pros::motor_encoder_units_e_t units,
                                               const std::uint8_t index = 0) const = 0;
