...
class Motor : public AbstractMotor, public Device {
  public:
     ...
     *  Motor reversed_motor(-2); //Creates a reversed motor on port 1 port 1 without altering gearset or encoder
     * units Motor blue_motor(3, pros::v5::MotorGears::blue); //Creates a motor on port 3 with blue gear set Motor
     * rotations_motor(4, pros::v5::MotorGears::green, pros::v5::MotorUnits::rotations); //port 4 w/ rotations
     *
     * }
     * \endcode
     *
