...
template <typename T, typename Char, size_t NUM_ARGS> struct arg_data<T, Char, NUM_ARGS, 0> {
    ...
    template <typename... U> FMT_CONSTEXPR FMT_INLINE arg_data(const U&... init)
      : args_ {init...} {}
 ...
 */
// DEPRECATED!
template <typename Visitor, typename Context> FMT_CONSTEXPR FMT_INLINE auto
...
template <typename Context> class basic_format_args {
  ...
  public:
    ...
    /**
     ...
     \endrst
     */
    template <typename... Args> constexpr FMT_INLINE basic_format_args(const format_arg_store<Context, Args...>& store)
